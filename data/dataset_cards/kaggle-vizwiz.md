...
- license: CC-BY-4.0
- permitted_usage: eval
- commercial_use_allowed: True
- redistribution_allowed: True
- derivative_use_allowed: True
- region/country/language coverage: North America | United States | en
- modality: image
- task mapping: image_accessibility_description, visual_question_answering
...
- reviewer notes: Kaggle mirror; keep metadata-only until reviewed.
