...
from registry_common import CANDIDATES_PATH, REJECTED_PATH

from data.schemas.dataset_acceptance import evaluate_candidate
from data.schemas.source_registry import append_jsonl, read_jsonl, validate_candidate_records
...
def main() -> None:
    ...
    payload = reject_dataset(args.dataset_name, args.reason, args.candidates, args.rejected)
